...
class EdgeFlowOptimizer:
    ...
    def optimize_model(self, config: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
        ...
        try:
            ...
            # Create converter
            converter = tf.lite.TFLiteConverter.from_saved_model(model_path) if os.path.isdir(model_path) else tf.lite.TFLiteConverter.from_keras_model(tf.keras.models.load_model(model_path))

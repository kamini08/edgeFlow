...
This package provides comprehensive semantic analysis for DSL intermediate
representations, including shape validation, parameter checking, resource
constraints, and device compatibility.
"""

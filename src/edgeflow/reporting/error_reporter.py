...
class EdgeFlowErrorReporter:
    ...
    def _initialize_error_templates(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "missing_model": {
                ...
                "explanation": (
                    "EdgeFlow requires a model file to optimize. This should be the "
            ...
            "invalid_device": {
                ...
                "explanation": (
                    "EdgeFlow supports specific edge devices with known capabilities "
                    "and constraints."
                ),
                "suggestions": [
            ...
            "incompatible_quantization": {
                ...
                "message": (
                    "The quantization type is not compatible with the target device "
                    "or model format"
                ),
                "explanation": (
                    "Different devices and model formats have different quantization "
                    "capabilities."
                ),
                "suggestions": [
            ...
            "memory_limit_exceeded": {
                ...
                "explanation": (
                    "Each device has physical memory limitations that cannot be "
                    "exceeded."
                ),
                "suggestions": [
            ...
            "buffer_size_too_large": {
                ...
                "message": (
                    "The buffer size may cause memory pressure on the target device"
                ),
                "explanation": (
                    "Large buffer sizes can consume too much memory and slow down "
                    "performance."
                ),
                "suggestions": [
            ...
            "model_format_incompatible": {
                ...
                "message": (
                    "The model format is not compatible with the specified "
                    "optimizations"
                ),
                "explanation": (
                    "Different model formats support different optimization "
                    "techniques."
                ),
                "suggestions": [
            ...
            "fusion_not_supported": {
                ...
                "message": (
                    "The target device or model format doesn't support operation fusion"
                ),
                "explanation": (
                    "Operation fusion requires specific hardware or software support."
                ),
                "suggestions": [
            ...
            "optimization_conflict": {
                ...
                "explanation": (
                    "Some optimization techniques work against each other or have "
                    "trade-offs."
                ),
                "suggestions": [
            ...
            "invalid_parameter_value": {
                ...
                "explanation": (
                    "Parameters have specific value ranges and formats for valid "
                    "operation."
                ),
                "suggestions": [
    ...
    def _initialize_suggestion_templates(self) -> Dict[str, Dict[str, List[str]]]:

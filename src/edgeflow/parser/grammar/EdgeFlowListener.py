...
class EdgeFlowListener(ParseTreeListener):
    ...
    def enterHybridOptimizationStmt(
        self, ctx: EdgeFlowParser.HybridOptimizationStmtContext
    ):
        pass

    # Exit a parse tree produced by EdgeFlowParser#hybridOptimizationStmt.
    def exitHybridOptimizationStmt(
        self, ctx: EdgeFlowParser.HybridOptimizationStmtContext
    ):
        pass
    ...
    def enterResourceConstraintsStmt(
        self, ctx: EdgeFlowParser.ResourceConstraintsStmtContext
    ):
        pass

    # Exit a parse tree produced by EdgeFlowParser#resourceConstraintsStmt.
    def exitResourceConstraintsStmt(
        self, ctx: EdgeFlowParser.ResourceConstraintsStmtContext
    ):
        pass
    ...
    def enterDeploymentConfigStmt(
        self, ctx: EdgeFlowParser.DeploymentConfigStmtContext
    ):
        pass
